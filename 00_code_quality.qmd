...
You can download this .qmd file from [here](https://github.com/proback/264_fall_2026/blob/main/00_code_quality.qmd).  Just hit the Download Raw File button.
...
VACCINE.DATA <- read_csv("https://proback.github.io/264_fall_2026/Data/vaccinations_2021.csv")
