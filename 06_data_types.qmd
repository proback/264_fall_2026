...
You can download this .qmd file from [here](https://github.com/proback/264_fall_2026/blob/main/06_data_types.qmd).  Just hit the Download Raw File button.
...
babynames <- read_csv("https://proback.github.io/264_fall_2026/Data/babynames_2000.csv")
