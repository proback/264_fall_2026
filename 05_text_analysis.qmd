...
You can download this .qmd file from [here](https://github.com/proback/264_fall_2026/blob/main/05_text_analysis.qmd).  Just hit the Download Raw File button.
...
# write_csv(three_works, "~/264_fall_2026/Data/three_works.csv")
```

```{r}
# three_works <- read_csv("https://proback.github.io/264_fall_2026/Data/three_works.csv")
# three_works2 <- read_csv("Data/three_works.csv") 

library(RCurl)
three_works <- read_csv(
  file = getURL("https://raw.githubusercontent.com/proback/264_fall_2026/refs/heads/main/Data/three_works.csv", .encoding = "UTF-8"))
...
frankenstein |> slice_tail(n = 10)   # spoiler alert!!
...
```{r}
# may have to hit 1 to download
get_stopwords() |> print(n = 50)  # snowball is default - a bit smaller
...
```{r}
# may have to hit 1 to download or confirm you'll cite in pubs
...
# potter_untidy <- read_csv("https://proback.github.io/264_fall_2026/Data/potter_untidy.csv") |>
# potter_untidy <- read_csv("Data/potter_untidy.csv")

potter_untidy <- read_csv(
  file = getURL("https://raw.githubusercontent.com/proback/264_fall_2026/refs/heads/main/Data/potter_untidy.csv", .encoding = "UTF-8")) |>
...
# potter_locations <- read_csv("https://proback.github.io/264_fall_2026/Data/potterlocations.csv") |>
# potter_locations <- read_csv("Data/potterlocations.csv")

potter_locations <- read_csv(
  file = getURL("https://raw.githubusercontent.com/proback/264_fall_2026/refs/heads/main/Data/potterlocations.csv", .encoding = "UTF-8")) |>
  mutate(value = str_to_lower(value))

potter_locations

# potter_names <- read_csv("https://proback.github.io/264_fall_2026/Data/potternames.csv") |>
# potter_names <- read_csv("Data/potternames.csv") |>
potter_names <- read_csv(
  file = getURL("https://raw.githubusercontent.com/proback/264_fall_2026/refs/heads/main/Data/potternames.csv", .encoding = "UTF-8")) |>
...
# potter_spells <- read_csv("https://proback.github.io/264_fall_2026/Data/potter_spells.csv") |>
# potter_spells <- read_csv("Data/potter_spells.csv") |>
potter_spells <- read_csv(
  file = getURL("https://raw.githubusercontent.com/proback/264_fall_2026/refs/heads/main/Data/potter_spells.csv", .encoding = "UTF-8")) |>
